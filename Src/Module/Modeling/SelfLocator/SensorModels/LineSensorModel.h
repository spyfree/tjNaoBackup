...
{
private:
  const std::vector<const LinesPercept::LineOnField*>& lines; /**< Reference to the lines. */
...
public:
  ...
  LineSensorModel(const SelfLocatorParameter& selfLocatorParameter,
    const std::vector<const LinesPercept::LineOnField*>& lines, const FrameInfo& frameInfo, 
