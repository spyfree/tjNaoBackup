...
// 	double standingSy;	/**< Sy when standing, different from sy when walking.*/
	...
	int useHipRollCompensationRight;  //Whether to use HipRoll Compensation, When robot turn right
	int useHipRollCompensationLeft;   //Whether to use HipRoll Compensation, When robot turn left
	double pRHipRollCompensator, pLHipRollCompensator;/**< Compensator Param of HipRoll Angles when Single Supporting*/
	double pRHipRollCompensatorRight, pLHipRollCompensatorRight;
	double pRHipRollCompensatorLeft, pLHipRollCompensatorLeft;
