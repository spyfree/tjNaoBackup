...
#include "PrviewControllerOutput.h"
...
public:
	...
	*/
	...
	/**
	* Get Reference CoM in world coordinate
	* @param preBuffer Preview buffer
	* @param walkParam Walking parameters
	*/
	PrviewControllerOutput getRefCOM(PreviewBuffer& preBuffer, const PreviewWalkParam& walkParam);
	PrviewControllerOutput getRefCOM(PreviewBuffer& preBuffer, const PreviewWalkParam& walkParam, const PrviewControllerState& pcState);
// 	Vector3<double> getRefCOM(PreviewBuffer& preBuffer, const PreviewWalkParam& walkParam, Vector3<double>& mRBody, Vector3<double>& refRBody);
private:
