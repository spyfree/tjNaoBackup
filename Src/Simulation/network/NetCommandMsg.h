#ifndef NetCOMMANDMSG_H
#define NetCOMMANDMSG_H
typedef enum 
{
	...
	idDebugClassImage, /*!< Classifyed image, size: 208*160 byte*/
...
public:
	NetCommandMsg();
	NetCommandMsg(NetCMsgID commandmsg,double data1,double data2,double data3);
public:
	NetCMsgID RS_COMMAND;
