...
public:
  ...
  * @return The id.
  */
  int getActuatorportId(const std::string& portName) const;
  ...
  * @return The id.
  */
  int getSensorportId(const std::string& portName) const;
  ...
  */
  ...
  /**
  * The function returns the current value of a certain sensorport.
  * An assertion fails if the type of the sensorport is not doubleArraySensor.
  * @param id The id of the port.
  * @param value The current value.
  */
  void getSensorValue(int id, double*& value);
  ...
  * @param fullObjectName The name of the object, to which the drawing should be attached
  * @param drawing The drawing
  */
  void registerDrawing(const std::string& fullObjectName, Controller3DDrawing* drawing);
  ...
  * @param fullObjectName The name of the object, from which the drawing should be removed
  * @param drawing The drawing
  */
  void unregisterDrawing(const std::string& fullObjectName, Controller3DDrawing* drawing);
