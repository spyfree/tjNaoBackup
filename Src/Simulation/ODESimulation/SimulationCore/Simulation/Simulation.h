...
private:
  ...
  */
  ...
  std::map<dGeomID, SimSensor*> collisionSensors;
  ...
  AutomaticObjectDisablingParammeters autoObjectDisableParameters;
  ...
  */
   ...
   */
  void collectCollisionSensorGeometry(SimSensor* sensor, SimObject* object);
...
public:
  ...
  */
  ...
  /** Get Light show cones flag from graphics manager (encapsulated function) */
  bool getLightShowCones();
  ...
  * @return The id
  */
  int getActuatorportIdByPartOfName(const std::vector<std::string>& parts) const;
  ...
  * @return The id
  */
  int getSensorportIdByPartOfName(const std::vector<std::string>& parts) const;
  ...
  */
  ...
  /**
  * Returns the material for a given name.
  * @param name The name of the material searched for.
  * @return A pointer to the material, or 0 if it does not exist.
  */
  ...
  * @param The drawing
  */
  void registerControllerDrawing(const std::string& objectName, Controller3DDrawing* drawing);

  /** Unregisters controller drawings at an object in the simulation scene.
  * @param The name of the object
  * @param The drawing
  */
  void unregisterControllerDrawing(const std::string& objectName, Controller3DDrawing* drawing);
  ...
  */
  ...
  bool getMultisampledFBOsCapability();
  ...
  */
  ...
  /**
  * Set linear velocity of objet and its child objectes
  * @param object A pointer to the root node of the object
  * @param vx, vy, vz velocity along the three axis in world coordinate
  */
  void setObjectLinearVelocity(SimObject* object, double vx, double vy, double vz);
  /**
  * Set Angular velocity of objet and its child objectes
  * @param object A pointer to the root node of the object
  * @param vx, vy, vz velocity around the three axis in world coordinate
  */
  void setObjectAngularVelocity(SimObject* object, double vx, double vy, double vz);
};
