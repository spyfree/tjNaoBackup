...
SimObject* ComplexShape::clone() const
{
  ...
  newComplexShape->useTriangleMesh = this->useTriangleMesh;
  newComplexShape->useOBB = this->useOBB;
  newComplexShape->useABB = this->useABB;
  std::vector<PhysicalObject*>::const_iterator physRepIter;
  for(physRepIter = this->physicalRepresentation.begin(); physRepIter != this->physicalRepresentation.end(); ++physRepIter)
  {
