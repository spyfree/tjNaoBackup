...
Plane::Plane() : a(0.0), b(0.0), c(0.0), d(0.0), surface(0), invisible(false), materialIndex(-1), material(""), geometry(0)
{
}

Plane::Plane(const AttributeSet& attributes) : a(0.0), b(0.0), c(0.0), d(0.0), surface(0), invisible(false), materialIndex(-1), material(""), geometry(0)
{
...
{
  this->geometry = dCreatePlane(collisionSpace, dReal(a),dReal(b),dReal(c),dReal(d));
  //set user data pointer of ODE geometry object to this plane object
  dGeomSetData(this->geometry, this);
}
...
void Plane::precomputeDrawingParameter()
{
  ...
  //origin
  Vector3d p0 = this->projectPointOnPlane(Vector3d(0.0,0.0,0.0));

  //point1
  Vector3d p1 = this->projectPointOnPlane(Vector3d(1.0,1.0,1.0));
  drawingPoint1 = p1 - p0;
  ...
  //point2
  Vector3d p2 = this->projectPointOnPlane(Vector3d(-1.0,1.0,1.0));
  drawingPoint2 = p2 - p0;
  ...
  //point3
  Vector3d p3 = this->projectPointOnPlane(Vector3d(-1.0,-1.0,1.0));
  drawingPoint3 = p3 - p0;
  ...
  //point4
  Vector3d p4 = this->projectPointOnPlane(Vector3d(1.0,-1.0,1.0));
  drawingPoint4 = p4 - p0;
