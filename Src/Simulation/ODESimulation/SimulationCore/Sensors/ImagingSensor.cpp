...
void ImagingSensor::drawObject(const VisualizationParameterSet& visParams)
{
  ...
  {
    double dist(simulation->getStandardLength());
                                           ...
                                           ErrorManager* errorManager)
{
  ...
  else if(name == "OpeningAngles")
  {
    ...
    aspect = tan(angleX * M_PI / 360) / tan(angleY * M_PI / 360);
  }
  else if(name == "Range")
  {
...
void ImagingSensor::postProcessAfterParsing()
{
}
