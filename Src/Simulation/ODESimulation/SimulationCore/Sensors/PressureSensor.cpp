...
{
	Sensorport* pressurePort = new Sensorport("pressure", 0, doubleSensor, 
		this, -10, 100);
	sensorportList.push_back(pressurePort);
}
...
void PressureSensor::computeValue(double &value, int portID)
{
