...
public:
  ...
  * @return The kind
  */
  virtual std::string getKind() const {return "motor";}
  ...
  */
   ...
   *
   */
  virtual unsigned short getNumberOfParsedAxes(){return numberOfParsedAxes;};
   ...
   */
  virtual MotorAxisDescription* getAxis(int index){return &axes[index];};

  /**
   *  Returns the maximum force of the motor
   *  @return The maximum force
   */
  virtual double getMaxForce(){return maxForce;};

  /**
   *  Returns the maximum velocity of the motor
   *  @return The maximum velocity
   */
  virtual double getMaxVelocity(){return maxVelocity;};
   ...
   */
  virtual double getControllerOutput(const double currentJointValue);
   ...
   *  @param attributes The attributes of the element
   */
  virtual void parseController(const std::string& name, const AttributeSet& attributes);
  ...
  virtual void setDefaultController();
