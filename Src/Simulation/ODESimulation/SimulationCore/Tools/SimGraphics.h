...
public:
  ...
  */
  ...
  /** Begin recording AVI movie
  * @param name name of the avi to save
  */
  bool beginAVIRecording(std::string& name);

  /** End recording AVI movie
  */
  bool endAVIRecording();

  /** Add one AVI frame
  *	@param width width of the movie
  * @param height height of the movie
  */
  bool addAVIFrame(unsigned int width, unsigned int height);
  ...
  */
  ...
  bool checkMultisampledFBOCapability();
